const ICONS = {
  ...
  image: <><rect x="3.5" y="5" width="17" height="14" rx="2" /><circle cx="9" cy="9.5" r="1.6" /><path d="m5.5 16.5 4-4 2.5 2.5 3-3 3.5 3.5" /></>,
  bell: <><path d="M6 9.5a6 6 0 0 1 12 0c0 4.4 1.6 5.8 1.6 5.8H4.4S6 13.9 6 9.5Z" /><path d="M10.3 19a2 2 0 0 0 3.4 0" /></>,
  upload: <><path d="M12 16V4.5" /><path d="m7.5 8.5 4.5-4 4.5 4" /><path d="M5 15.5v3A1.5 1.5 0 0 0 6.5 20h11a1.5 1.5 0 0 0 1.5-1.5v-3" /></>,
  trash: <><path d="M4.5 6.5h15" /><path d="M8 6.5V5a1.5 1.5 0 0 1 1.5-1.5h5A1.5 1.5 0 0 1 16 5v1.5" /><path d="M6.5 6.5 7.3 19a1.5 1.5 0 0 0 1.5 1.4h6.4a1.5 1.5 0 0 0 1.5-1.4l.8-12.5" /></>,
